...
public class ProcessingDetravPortableCharger  implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes orePrefixes, Materials materials, String s, String s1, ItemStack itemStack) {
        ...
        switch ((int) voltage) {
            case 32:
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.Steel, new long[]{4 * 100000L, 32L, 1L, -3L}, loss);
                ...
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.Steel, new long[]{4 * 75000L, 32L, 1L, -3L}, loss);
                ...
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.Steel, new long[]{4 * 50000L, 32L, 1L, -3L}, loss);
                ...
                break;
            case 128:
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.Aluminium, new long[]{4 * 400000L, 128L, 2L, -3L}, loss);
                GT_ModHandler.addCraftingRecipe(dStack, GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS | GT_ModHandler.RecipeBits.BUFFERED, new Object[]{"WBW", "BCB", "WBW", Character.valueOf('C'), OrePrefixes.circuit.get(Materials.Good), Character.valueOf('B'), ItemList.Battery_RE_MV_Lithium.get(1L, new Object[0]), Character.valueOf('W'), itemStack});
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.Aluminium, new long[]{4 * 300000L, 128L, 2L, -3L}, loss);
                ...
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.Aluminium, new long[]{4 * 200000L, 128L, 2L, -3L}, loss);
                ...
                break;
            case 512:
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.StainlessSteel, new long[]{4 * 1600000L, 512L, 3L, -3L}, loss);
                ...
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.StainlessSteel, new long[]{4 * 1200000L, 512L, 3L, -3L}, loss);
                ...
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.StainlessSteel, new long[]{4 * 800000L, 512L, 3L, -3L}, loss);
                GT_ModHandler.addCraftingRecipe(dStack, GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS | GT_ModHandler.RecipeBits.BUFFERED, new Object[]{"WBW", "BCB", "WBW", Character.valueOf('C'), OrePrefixes.circuit.get(Materials.Advanced), Character.valueOf('B'), ItemList.Battery_RE_HV_Sodium.get(1L, new Object[0]), Character.valueOf('W'), itemStack});
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.StainlessSteel, new long[]{4 * 1000000L, 512L, 3L, -3L}, loss);
                GT_ModHandler.addCraftingRecipe(dStack, GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS | GT_ModHandler.RecipeBits.BUFFERED, new Object[]{"WBW", "BCB", "WBW", Character.valueOf('C'), OrePrefixes.circuit.get(Materials.Advanced), Character.valueOf('B'), OrePrefixes.battery.get(Materials.Elite), Character.valueOf('W'), itemStack});
				break;
            case 2048:
                dStack = DetravMetaGeneratedTool01.INSTANCE.getToolWithStatsPlus(108, 1, materials, Materials.Titanium, new long[]{4 * 10000000L, 2048L, 4L, -3L}, loss);
                GT_ModHandler.addCraftingRecipe(dStack, GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS | GT_ModHandler.RecipeBits.BUFFERED, new Object[]{"WBW", "BCB", "WBW", Character.valueOf('C'), OrePrefixes.circuit.get(Materials.Data), Character.valueOf('B'), OrePrefixes.battery.get(Materials.Master), Character.valueOf('W'), itemStack});
                break;				
        }
    }
}